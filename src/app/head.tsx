export default function Head() {
  return (
    <>
      <title>QCD Transport</title>
      <meta content="width=device-width, initial-scale=1" name="viewport" />
      <meta name="description" 
      content="QCD est une entreprise de transports spécialisée dans la livraison de colis et de palettes dans toute la France, 7 jours sur 7. 
      Nous proposons un service de transport standard ou express avec des véhicules de 15m3.
